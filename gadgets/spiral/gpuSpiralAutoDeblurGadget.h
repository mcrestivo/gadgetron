#ifndef gpuSpiralAutoDeblurGadget_H
#define gpuSpiralAutoDeblurGadget_H
#pragma once
...
namespace Gadgetron{
  ...
  class EXPORTGADGETS_SPIRAL gpuSpiralAutoDeblurGadget :
    public Gadget3< ISMRMRD::AcquisitionHeader, hoNDArray< std::complex<float> >, hoNDArray<float> >
  {

  public:
    GADGET_DECLARE(gpuSpiralAutoDeblurGadget);

    gpuSpiralAutoDeblurGadget();
    virtual ~gpuSpiralAutoDeblurGadget();
